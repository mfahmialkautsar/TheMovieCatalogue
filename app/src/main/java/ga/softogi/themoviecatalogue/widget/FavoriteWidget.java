...
public class FavoriteWidget extends AppWidgetProvider {
    /**
     * Sebaiknya tutup dulu aplikasi sebelum ngotak ngatik widget, karena akan forced close.
     * Saya sudah mengikuti saran dicoding untuk menambahkan beberapa atribut tambahan, hasilnya sama.
     * Sudah dicoba berbagai macam cara juga tidak berhasil, karena kode errornya pun tidak jelas
     * dan tidak memberitahu apa dan dimana letak errornya.
     */
