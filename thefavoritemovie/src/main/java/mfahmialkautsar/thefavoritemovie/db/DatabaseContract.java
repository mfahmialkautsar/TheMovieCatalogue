package mfahmialkautsar.thefavoritemovie.db;
...
public class DatabaseContract {
    ...
    private static final String AUTHORITY_MOVIE = "mfahmialkautsar.themoviecatalogue.provider.FavMovieProvider";
    private static final String AUTHORITY_TV = "mfahmialkautsar.themoviecatalogue.provider.FavTvProvider";
