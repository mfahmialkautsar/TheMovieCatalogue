package mfahmialkautsar.themoviecatalogue.adapter;
...
import mfahmialkautsar.themoviecatalogue.util.CustomOnItemClickListener;
    ...
    public void onBindViewHolder(@NonNull final MovieViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new CustomOnItemClickListener(position, new CustomOnItemClickListener.OnItemClickCallback() {
            ...
            public void onItemClicked(View view, int position) {
                ...
                Uri uri = Uri.parse(FavDatabaseContract.TableColumns.CONTENT_URI_MOVIE + "/" + getMovieDataList().get(position).getId());
