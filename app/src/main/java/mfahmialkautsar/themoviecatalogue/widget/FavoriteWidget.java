package mfahmialkautsar.themoviecatalogue.widget;
...
/**
 * THIS IS AN EXPERIMENTAL FEATURE, THERE MIGHT BE SOME BUGS
 */
public class FavoriteWidget extends AppWidgetProvider {

    public static final String EXTRA_ITEM = "mfahmialkautsar.EXTRA_ITEM";
    private static final String TOAST_ACTION = "mfahmialkautsar.TOAST_ACTION";
