...
import mfahmialkautsar.themoviecatalogue.util.InfiniteOnScrollListener;
...
public class HomeTvFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            ArrayList<TvData> tvList = savedInstanceState.getParcelableArrayList(STATE_TV);
            adapter.setTvDataList(tvList);
        }
    }

    private void addScroll(final String keyword, final boolean nextPage) {
        infiniteOnScrollListener = new InfiniteOnScrollListener(gridLayoutManager, page) {
            @Override
        ...
        rvMovies.addOnScrollListener(infiniteOnScrollListener);
    }

    private void removeScroll() {
        rvMovies.removeOnScrollListener(infiniteOnScrollListener);
    }
