package mfahmialkautsar.themoviecatalogue.reminder;
...
import mfahmialkautsar.themoviecatalogue.activity.DetailActivity;
import mfahmialkautsar.themoviecatalogue.activity.MainActivity;
import mfahmialkautsar.themoviecatalogue.db.FavDatabaseContract;
import mfahmialkautsar.themoviecatalogue.entity.MovieData;
import mfahmialkautsar.themoviecatalogue.network.NetworkContract;
...
public class ReleasedFilmsService extends JobService {
    ...
    private void getReleased(final JobParameters job) {
        ...
        client.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    for (int i = 0; i < list.length(); i++) {
                        ...
                        MovieData movieData = new MovieData(id, title, overview, release, rating, poster, backdrop_path, MovieData.TYPE_MOVIE);
                    ...
                    Log.d("Exception Movie", e.getMessage() != null ? e.getMessage() : "null");
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                Log.d("onFailure Movie", error.getMessage() != null ? error.getMessage() : "null");
                jobFinished(job, true);
            }
        });
    }
    ...
    private void showNotification(Context context, String message, Object extras, int extraId) {
        ...
        Uri uri = Uri.parse(FavDatabaseContract.TableColumns.CONTENT_URI_MOVIE + "/" + extraId);
